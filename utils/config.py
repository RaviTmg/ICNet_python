...
class Config(object):
    ...
    ADERELABEL_eval_list = os.path.join('icnet_python_data/list/aderelabel_val_list.txt')

    ADERELABEL_train_list = os.path.join('icnet_python_data/list/aderelabel_train_list.txt')
